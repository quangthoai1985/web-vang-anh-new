...
const DirectiveDocuments: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              >
                ...
                <h1 className="text-2xl font-bold text-gray-900 uppercase">VĂN BẢN CHỈ ĐẠO</h1>
              </div>
            </div>
            {canManageDocuments && (
              <button
      ...
      {/* View Modal - Redesigned Split View */}
      {
